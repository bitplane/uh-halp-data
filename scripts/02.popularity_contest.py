...
def main():
    parser = argparse.ArgumentParser(description="Process a file containing binary paths and repos.")
    parser.add_argument('file_name', type=str, help="The name of the file to process")
    parser.add_argument('--batch-size', type=int, default=10, help="Batch size for processing")
    parser.add_argument('--seed', type=int, help="Random seed for reproducibility")
    parser.add_argument('--host', type=str, default="localhost", help="Host for ranking service")
    parser.add_argument('--port', type=int, default=11434, help="Port for ranking service")
